...
15% when the bill is between 
$50 and $200, and 10% if the bill is more than $200.

In the end, John would like to have 2 arrays: 1) Containing all 
three tips (one for each bill) 2) 
...
// console.log(TipCalculater(300));

var bills = [124 , 48 , 268];
var tips = [TipCalculater(bills[0]) , TipCalculater(bills[1]) , TipCalculater(bills[2])];
